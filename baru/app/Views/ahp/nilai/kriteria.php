        ...
        <div class="card-body">
            ...
            <div class="col-12 d-flex m-2 justify-content-center">
                ...
                <select class="form-control col-lg-4 col-sm-6 py-2" oninput="update(<?= $n['id_nilai']; ?>,this)">
                    ...
                    <option value="2" <?= $n['nilai'] == 2 ? "selected" : ""; ?>>2 - sedikit agak lebih penting dari
                    </option>
                    <option value="3" <?= $n['nilai'] == 3 ? "selected" : ""; ?>>3 - sedikit lebih penting dari</option>
                    <option value="4" <?= $n['nilai'] == 4 ? "selected" : ""; ?>>4 - agak lebih penting dari</option>
                    <option value="5" <?= $n['nilai'] == 5 ? "selected" : ""; ?>>5 - lebih penting dari</option>
                    <option value="6" <?= $n['nilai'] == 6 ? "selected" : ""; ?>>6 - agak lebih mutlak penting dari
                    </option>
                    <option value="7" <?= $n['nilai'] == 7 ? "selected" : ""; ?>>7 - lebih mutlak dari</option>
                    <option value="8" <?= $n['nilai'] == 8 ? "selected" : ""; ?>>8 - agak mutlak penting dari</option>
                    ...
                    <option value="0.125" <?= $n['nilai'] == 0.125 ? "selected" : ""; ?>>1/8 - agak mutlak tidak penting
                        dari</option>
                    <option value="0.142857" <?= $n['nilai'] == 0.142857 ? "selected" : ""; ?>>1/7 - lebih tidak mutlak
                        dari</option>
                    <option value="0.166667" <?= $n['nilai'] == 0.166667 ? "selected" : ""; ?>>1/6 - agak lebih tidak
                        mutlak dari</option>
                    <option value="0.2" <?= $n['nilai'] == 0.2 ? "selected" : ""; ?>>1/5 - lebih tidak penting dari
                    </option>
                    <option value="0.25" <?= $n['nilai'] == 0.25 ? "selected" : ""; ?>>1/4 - agak lebih tidak penting
                        dari</option>
                    <option value="0.3" <?= $n['nilai'] == 0.3 ? "selected" : ""; ?>>1/3 - sedikit lebih tidak penting
                        dari</option>
                    <option value="0.5" <?= $n['nilai'] == 0.5 ? "selected" : ""; ?>>1/2 - sedikit agak lebih tidak
                        penting dari</option>
                </select>
                <?php foreach ($kriteria as $k) : ?>
